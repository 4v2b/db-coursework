...
<body>
  ...
  if ($_SERVER["REQUEST_METHOD"] === "GET" && isset($_GET["IdGroup"])) {
    ...
    echo "<table> ";
    $stmt->execute();
    if ($stmt->rowCount() > 0) $buttonText = 'Додати нового студента';
    else $buttonText = 'Створити першого студента у групі';
    ...
    isset($_POST["idStudent"]) && isset($_POST["Name"]) && isset($_POST["LastName"]) &&
